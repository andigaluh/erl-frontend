...
class Form_spd_luar_model extends CI_Model
{
    ...
    public function form_spd_luar()
    {
        ...
        else
        {
            ...
            $this->db->select(array(
                ...
                $this->tables['city'].'.title as to_city_name'
            ));

            $this->db->join('users', 'users_spd_luar.created_by = users.id', 'left');
            ...
            $this->db->join('city','users_spd_luar.to_city_id = city.id');
    ...
    public function get_transportation()
    {
        ...
        $this->response = $this->db->get($this->tables['transportation']);
    ...
    public function get_city()
    {
        ...
        $this->response = $this->db->get($this->tables['city']);
    ...
    public function update($id, array $data)
    {
        ...
        $this->trigger_events('extra_where');
        $this->db->update($this->tables['users_spd_luar'], $data, array('id' => $form_spd_luar->id));
