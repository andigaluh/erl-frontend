            ...
            <div class="col-md-12">
                <div class="grid simple ">                            
                    <div class="grid-body no-border">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4><?php echo lang('search_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('employee_stat_subheading');?></span></h4>
                            </div>
                        </div>
                        <?php echo form_open(site_url('employee_status/keywords'),array( 'id'=>'search_employee_stat'))?>
                        ...
                        <div class="row">
                            <div class="col-md-4 page_limit">
                                ...
                                <?php 
                                    ...
                                    echo '&nbsp;'.lang('found_subheading').'&nbsp;'.$num_rows_all.'&nbsp;'.lang('employee_stat_subheading');
                                ?>
                                <?php echo form_close();?>
                            </div>
                            <div class="col-md-10">
  ...
  <div class="modal-dialog" id="modaldialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_employee_stat', 'add_employee_stat')?></h4>
      </div>
      <p class="error_msg" id="MsgBad" style="background: #fff; display: none;"></p>
      <div class="modal-body">
        <?php echo form_open('employee_status/add/', array('id'=>'formadd2'))?> 
...
<script type="text/javascript">
    ...
    function getTable() 
    {
        $('#tabel').load('<?php echo site_url('employee_status/get_table/'); ?>');
    }
	
	function getModal() 
    {
        $('#modal').load('<?php echo site_url('employee_status/get_modal/'); ?>');
    }
