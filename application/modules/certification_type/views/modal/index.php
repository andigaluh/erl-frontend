...
<!--Edit Modal-->
        <?php echo form_open('certification_type/update/'.$user->id, array('id'=>'formupdate'.$user->id))?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_crt_type', 'edit_crt_type')?></h4>
                    </div>
        ...
        <div class="modal fade" id="deleteModal<?php echo $user->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <?php echo form_open('certification_type/delete/'.$user->id, array("id"=>"formdelete".$user->id))?>
