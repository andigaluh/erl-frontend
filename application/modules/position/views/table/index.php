...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th width="10%"><?php echo anchor('position/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('abbrevation'));?></th>
            <th width="10%"><?php echo anchor('position/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('position_group'));?></th>
			<th width="10%"><?php echo anchor('position/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('position_parent'));?></th>
			<th width="10%"><?php echo anchor('position/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('organization'));?></th>
			<th width="10%"><?php echo anchor('position/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('description'));?></th>
