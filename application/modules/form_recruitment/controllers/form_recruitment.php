...
class Form_recruitment extends MX_Controller {
  ...
  public $data;
    ...
    {
        $this->_render_page('form_recruitment/approval/hrd', $this->data);
    }

    function approval_spv()
    {
        $this->_render_page('form_recruitment/approval/supervisor', $this->data);
    }
    ...
    function _render_page($view, $data=null, $render=false)
    {
        ...
        if ( ! $render)
        {
            $this->load->library('template');
                ...
                }elseif(in_array($view, array('form_recruitment/approval/hrd')))
                {
                    $this->template->set_layout('default');
