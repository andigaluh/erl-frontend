<div class="page-content">
            ...
            <div class="col-md-12">
                <div class="grid simple ">                            
                    <div class="grid-body no-border">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4><?php echo lang('search_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('empl_stat_subheading');?></span></h4>
                            </div>
                        </div>
                        <?php echo form_open(site_url('empl_status/keywords'),array( 'id'=>'search_empl_stat'))?>
    ...
    <thead>
        <tr>
            ...
            <th width="10%"><?php echo anchor('empl_status/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('index_ftitle_th'));?></th>
            <th width="10%"><?php echo lang('index_action_th');?></th>                                  
        </tr>
    </thead>
    <tbody>
        <?php if($_num_rows > 0) { ?>
            <?php foreach ($empl_status as $user):?>
                <tr>
                    <td valign="middle">
                         <div class="checkbox check-default">
                        ...
                        <div class="row">
                            <div class="col-md-4 page_limit">
                                ...
                                <?php 
                                    ...
                                    echo '&nbsp;'.lang('found_subheading').'&nbsp;'.$num_rows_all.'&nbsp;'.lang('empl_stat_subheading');
                                ?>
                                <?php echo form_close();?>
                            </div>
                            <div class="col-md-10">
  ...
  <div class="modal-dialog" id="modaldialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_empl_stat', 'add_empl_stat')?></h4>
      </div>
      <p class="error_msg" id="MsgBad" style="background: #fff; display: none;"></p>
      <div class="modal-body">
        <?php echo form_open('empl_status/add/', array('id'=>'formadd2'))?> 
...
<script type="text/javascript">
    ...
    function getTable() 
    {
        $('#tabel').load('<?php echo site_url('empl_status/get_table/'); ?>');
    }
	
	function getModal() 
    {
        $('#modal').load('<?php echo site_url('empl_status/get_modal/'); ?>');
    }
