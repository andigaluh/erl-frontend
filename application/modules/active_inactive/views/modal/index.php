...
<!--Edit Modal-->
        <?php echo form_open('active_inactive/update/'.$user->id, array('id'=>'formupdate'.$user->id))?>
        ...
        <div class="modal fade" id="deleteModal<?php echo $user->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <?php echo form_open('active_inactive/delete/'.$user->id, array("id"=>"formdelete".$user->id))?>
