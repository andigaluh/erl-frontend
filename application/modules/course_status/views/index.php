<div class="page-content">
            ...
            <div class="col-md-12">
                <div class="grid simple ">                            
                    <div class="grid-body no-border">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4><?php echo lang('search_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('crs_status_subheading');?></span></h4>
                            </div>
                        </div>
                        <?php echo form_open(site_url('course_status/keywords'),array( 'id'=>'search_crs_status'))?>
    ...
    <thead>
        <tr>
            ...
            <th width="10%"><?php echo anchor('course_status/index/'.$ftitle_param.'/title/'.(($sort_order == 'asc' && $sort_by == 'title') ? 'desc' : 'asc'), lang('index_ftitle_th'));?></th>
                        ...
                        <div class="row">
                            <div class="col-md-4 page_limit">
                                ...
                                <?php 
                                    ...
                                    echo '&nbsp;'.lang('found_subheading').'&nbsp;'.$num_rows_all.'&nbsp;'.lang('crs_status_subheading');
                                ?>
                                <?php echo form_close();?>
                            </div>
                            <div class="col-md-10">
  ...
  <div class="modal-dialog" id="modaldialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_crs_status', 'add_crs_status')?></h4>
      </div>
      <p class="error_msg" id="MsgBad" style="background: #fff; display: none;"></p>
      <div class="modal-body">
        <?php echo form_open('course_status/add/', array('id'=>'formadd2'))?> 
...
<script type="text/javascript">
    ...
    function getTable() 
    {
        $('#tabel').load('<?php echo site_url('course_status/get_table/'); ?>');
    }
	
	function getModal() 
    {
        $('#modal').load('<?php echo site_url('course_status/get_modal/'); ?>');
    }
