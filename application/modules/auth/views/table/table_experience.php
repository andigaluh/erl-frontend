<div id="tabel" class="row">
    <div class="col-md-6">
        <h4><?php echo lang('found_subheading')?>&nbsp;<span class="semi-bold"><?php echo $num_rows_experience;?>&nbsp;<?php echo lang('experience_subheading');?></span></h4>  
    </div>
...
<table class="table no-more-tables">
    ...
    <tbody id="tabel">
        ...
        <tr>
            ...
            <td valign="middle">
                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#editexperienceModal<?= $row->id?>"><?php echo lang('edit_button')?></button>
                &nbsp;|&nbsp;
                <button class='btn btn-danger btn-xs' type="submit" name="remove_levels" value="Delete" data-toggle="modal" data-target="#deleteexperienceModal<?php echo $row->id?>">Delete</button>
            </td>
        </tr>
        <?php }}else{?>
        <tr>
