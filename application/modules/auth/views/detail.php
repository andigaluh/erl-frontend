                                        ...
                                        <table class="table no-more-tables">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="10%"><?php echo 'Education' //anchor('auth/index/'.$fname_param.'/'.$email_param.'/first_name/'.(($sort_order == 'asc' && $sort_by == 'first_name') ? 'desc' : 'asc'), lang('index_fname_th'));?></th>
                                                    <th width="10%"><?php echo 'Description'//anchor('auth/index/'.$fname_param.'/'.$email_param.'/last_name/'.(($sort_order == 'asc' && $sort_by == 'last_name') ? 'desc' : 'asc'), lang('index_lname_th'));?></th>
                                                    ...
                                                    <th width="10%"><?php echo 'Degree'//anchor('auth/index/'.$fname_param.'/'.$email_param.'/last_name/'.(($sort_order == 'asc' && $sort_by == 'last_name') ? 'desc' : 'asc'), lang('index_lname_th'));?></th>
                                                    <th width="10%"><?php echo 'Education Group'//anchor('auth/index/'.$fname_param.'/'.$email_param.'/email/'.(($sort_order == 'asc' && $sort_by == 'email') ? 'desc' : 'asc'), lang('index_email_th'));?></th>
                                                    <th width="10%"><?php echo 'Institution';?></th>
                                                    <th width="10%"><?php echo lang('index_action_th');?></th>                                  
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php if ($user_education->num_rows() > 0){
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="middle"><?php echo $row->education;?></td>
                                                    <td valign="middle"><span class="muted"><?php echo $row->description;?></span></td>
                                                    <td valign="middle"><span class="muted"><?php echo $row->start_date;?></span></td>
                                                    <td valign="middle"><span class="muted"><?php echo $row->end_date;?></span></td>
