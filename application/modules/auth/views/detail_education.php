                        ...
                        <div class="row">
                                ...
                                <div class="grid simple ">                            
                                    <div class="grid-body no-border">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h4><?php echo lang('search_of_subheading')?>&nbsp;<span class="semi-bold"><?php echo lang('education_subheading');?></span></h4>
                                            </div>
                                        </div>
                                        ...
                                        <?php echo form_open(site_url('auth/keywords'))?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-4 search_label"><?php echo form_label(lang('index_education_title_th'),'education_title_search')?></div>
                                                        <div class="col-md-8"><?php// echo bs_form_input($education_title_search)?></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                            <div class="col-md-5">
                                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addeducationModal">Tambah</button>
                                            </div>
                                            <div class="col-md-7">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open('auth/add_education/'.$user->id, array('id'=>'formadd'))?> 
...
<div class="modal fade" id="editeducationModal<?=$row->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <?= form_open('auth/edit_education/'.$row->id, array('id'=>'formupdate'))?> 
             <div class="row form-row">
                <div class="col-md-3">
                    <?php echo lang('education_description', 'education_title');?>
                </div>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="title" value="<?php echo $row->education?>">         
                </div>
                ...
                <div class="col-md-3">
                    <?php echo lang('education_registration_date', 'education_regisration_date');?>
                </div>
                <div class="col-md-9">
                        <div class="input-with-icon right">
                            <div class="input-append success date no-padding">
                ...
                <div class="col-md-3">
                    <?php echo lang('education_status', 'education_status');?>
                </div>
                <div class="col-md-9">
                        <div class="input-with-icon right">
                            <div class="input-append success date no-padding">
...
<div class="modal fade" id="deleteeducationModal<?=$row->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo form_open('auth/delete_education/'.$row->id, array("id"=>"formdelete"))?>
