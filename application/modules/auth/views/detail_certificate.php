                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-8"><?php echo bs_form_input(array('id'=>'title', 'name'=>'title'));?></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="row">
                                                        <?php echo form_submit('submit',lang('search_button'),'class="btn btn-primary"')?>
                                                        <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addcertificateModal"><?php echo lang('add_button');?></button>
