                                    ...
                                    <div class="grid-body no-border">
                                        ...
                                        <?php echo form_open(site_url('auth/keywords'))?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-4 search_label"><?php echo form_label(lang('index_experience_title_th'),'experience_title_search')?></div>
                                                        <div class="col-md-8"><?php// echo bs_form_input($experience_title_search)?></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                            <div class="col-md-5">
                                                <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addexperienceModal">Tambah</button>
                                            </div>
                                            <div class="col-md-7">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open('auth/add_experience/'.$user->id, array('id'=>'formadd'))?> 
