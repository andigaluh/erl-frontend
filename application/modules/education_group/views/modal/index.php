...
<!--Edit Modal-->
        <?php echo form_open('education_group/update/'.$user->id, array('id'=>'formupdate'.$user->id))?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_edu_group', 'edit_edu_group')?></h4>
                    </div>
        ...
        <div class="modal fade" id="deleteModal<?php echo $user->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <?php echo form_open('education_group/delete/'.$user->id, array("id"=>"formdelete".$user->id))?>
